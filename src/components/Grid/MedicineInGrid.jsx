...
import headerMapping from '../../constant/medicineInHeaderMapping.js';
import InfoDialog from '../../components/Dialog/medicineInDialog.jsx';
import Form from '../Form/MedicineInForm.jsx';
...
const Grid = () => {
  ...
  const fetchRecord = useCallback(async () => {
    setIsLoading(true);
    try {
      const response = await axiosInstance.get('medicineInventory/getAllIn');
